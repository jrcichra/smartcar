...
cd containers/$1
docker buildx build --build-arg commit=$TRAVIS_COMMIT --build-arg processor=$(uname -m) --platform linux/amd64,linux/arm64,linux/arm/v7 -t jrcichra/smartcar_$1 --push .
